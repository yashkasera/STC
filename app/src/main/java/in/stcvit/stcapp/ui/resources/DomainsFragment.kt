...
import `in`.stcvit.stcapp.databinding.FragmentResourcesBinding
import `in`.stcvit.stcapp.model.Domain
import `in`.stcvit.stcapp.util.ClickListener
import `in`.stcvit.stcapp.util.RecyclerTouchListener
...
class DomainsFragment : Fragment() {
    ...
    private fun init() {
        ...
        list = arrayListOf(
            ...
            Domain("Data Science", R.drawable.ic_data_science, style2),
